...
public final class ProxySettings {
    ...
    public static final class Builder {
        ...
        /**
         * Takes the proxy settings from System properties and applies them to the {@link Builder}.
         *
         * @return this.
         */
        public ProxySettings.Builder applySystemProperties() {
            String proxyHost = System.getProperty("localMongoProxyHost");
            if (proxyHost != null) {
                this.host(proxyHost);
            }

            Integer proxyPort = Integer.parseInt(System.getProperty("localMongoProxyPort"));
            if (proxyPort != null) {
                this.port(proxyPort);
            }

            String proxyUsername = System.getProperty("localMongoProxyUsername");
            if (proxyUsername != null) {
                this.username(proxyUsername);
            }

            String proxyPassword = System.getProperty("localMongoProxyPassword");
